...
function AuxFilter.init(env)
  ...
  env.learn_trigger = normalize_trigger(config:get_string("aux_code/learn_trigger"), nil)
      or normalize_trigger(config:get_string("aux_code/aux_code_trigger"), nil)
      or ";"
  env.no_learn_trigger = normalize_trigger(config:get_string("aux_code/no_learn_trigger"), "")
  ...
  -- 设定是否显示辅助码，默认为显示
  env.show_aux_notice = config:get_string("aux_code/show_aux_notice") or 'true'
