...
local charset = {
  ...
  ["[音标扩展]"] = { first = 0x1d00, last = 0x1d7f },
  ["[音标增补]"] = { first = 0x1d80, last = 0x1dbf },
  ...
  ["[私用区补充A]"] = { first = 0xf0000, last = 0xfffff },
...
local function charset_comment_filter(input, env)
  ...
  -- 反查时不显示 Unicode 分区注释，常规输入受 charset_comment_filter 开关控制
  if not b or is_reverse or is_special then
